...
def Add_Prompt_for_Image_Bart(task_name,number,start_string,goal_string):
    return 'For Task ' + task_name + ', Given the first step and the last step, predict the intermediate ' + Number_to_String(number) + ' step.' + start_string + '.' + goal_string + '.'