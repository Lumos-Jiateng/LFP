...
import numpy as np
import os
from data.coin180_custom import step_list_180

language_sup_path = '/nfs4-p1/ljt/github/PTU/Full_coin_eval/language_sup/coin_full_features.npy'
...
class Coin_align(nn.Module):
    ...
    def forward(self,text_description,ff_start,lf_end,ff_action_label,lf_action_label):
        ...
        ff_target = F.one_hot(ff_action_label, num_classes=749) #[1,3] -> [1,0,0...],[0,0,1...]
        lf_target = F.one_hot(lf_action_label, num_classes=749) 
